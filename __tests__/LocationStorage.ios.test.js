...
describe('LocationStorage - iOS', () => {
  ...
  describe('saveLocation', () => {
    it('should save a new location on iOS', async () => {
      AsyncStorage.getItem.mockResolvedValue(null);
    ...
    it('should increment frequency when saving duplicate location on iOS', async () => {
      const location = createLocation(
        40.7128,
        -74.0060,
        '123 Main St',
    ...
    it('should move duplicate location to front of list on iOS', async () => {
    ...
    it('should limit recent locations to 20 items on iOS', async () => {
      const locations = [];
      for (let i = 0; i < 20; i++) {
        locations.push({
  ...
  describe('getRecentLocations', () => {
    it('should return empty array when no locations exist on iOS', async () => {
      AsyncStorage.getItem.mockResolvedValue(null);
    ...
    it('should return all recent locations on iOS', async () => {
  ...
  describe('deleteLocation', () => {
    it('should delete location by ID on iOS', async () => {
      const location1 = { ...createLocation(40.7128, -74.0060, '123 Main St', 'New York', 'USA', '10001', true), frequency: 1, lastUsed: Date.now() };
  ...
  describe('frequency increment', () => {
    it('should properly track frequency increments on iOS', async () => {
  ...
  describe('getLocationCount', () => {
    it('should return count of saved locations on iOS', async () => {
      const location1 = { ...createLocation(40.7128, -74.0060, '123 Main St', 'New York', 'USA', '10001', true), frequency: 1, lastUsed: Date.now() };
      const location2 = { ...createLocation(51.5074, -0.1278, '456 Oxford St', 'London', 'UK', 'WC1A1BB', true), frequency: 1, lastUsed: Date.now() };
